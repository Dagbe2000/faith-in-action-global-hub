...
const samplePartners: Partner[] = [
  { _id: '1', _type: 'partner', name: 'Africa Interfaith Council', country: 'Kenya', region: 'east-africa', type: 'faith', description: 'A pan-African coalition of 200+ faith organizations advocating for justice and peace.', website: '#', featured: true, africaSpotlight: true },
  { _id: '2', _type: 'partner', name: 'West Africa Justice Network', country: 'Ghana', region: 'west-africa', type: 'ngo', description: 'Faith-based NGO network focused on economic justice and governance accountability.', website: '#', featured: true, africaSpotlight: true },
  { _id: '3', _type: 'partner', name: 'Southern Africa Faith Forum', country: 'South Africa', region: 'southern-africa', type: 'faith', description: 'Ecumenical body addressing poverty, inequality, and social cohesion in Southern Africa.', website: '#', featured: false, africaSpotlight: true },
  { _id: '4', _type: 'partner', name: 'Evangelical Fellowship of Nigeria', country: 'Nigeria', region: 'west-africa', type: 'faith', description: 'Representing over 60,000 churches engaged in social advocacy and community development.', website: '#', featured: true, africaSpotlight: true },
  { _id: '5', _type: 'partner', name: 'Islamic Relief Worldwide', country: 'United Kingdom', region: 'europe', type: 'ngo', description: 'Global humanitarian organization working in 40+ countries on emergency relief and advocacy.', website: '#', featured: true, africaSpotlight: false },
  { _id: '6', _type: 'partner', name: 'World Council of Churches', country: 'Switzerland', region: 'europe', type: 'faith', description: 'Fellowship of 352 churches in 120 countries working together for unity, justice, and peace.', website: '#', featured: false, africaSpotlight: false },
  { _id: '7', _type: 'partner', name: 'Ethiopia Interfaith Forum', country: 'Ethiopia', region: 'east-africa', type: 'faith', description: 'Bringing together Orthodox, Catholic, Protestant, and Muslim leaders for social advocacy.', website: '#', featured: false, africaSpotlight: true },
  { _id: '8', _type: 'partner', name: 'Rwanda Reconciliation Initiative', country: 'Rwanda', region: 'east-africa', type: 'ngo', description: 'Faith-led program building on Rwanda\'s reconciliation journey to prevent future atrocities.', website: '#', featured: false, africaSpotlight: true },
]
